...
from .views import CreateVagueAPIView, AssignStudentToVagueAPIView , AssignQuizToVagueAPIView , VagueListAPIView, MesVaguesAPIView
...
urlpatterns = [
    ...
    path('student/mes-vagues/', MesVaguesAPIView.as_view(), name='student-mes-vagues'),
]